package app.spicetify.playback

import app.spicetify.domain.ProviderType
import app.spicetify.settings.CookieSource
...
class YtDlpPlaybackCookiesTest {
    private fun serviceWithBothSessions() = YtDlpService().apply {
        setCookieArguments(ProviderType.YOUTUBE_MUSIC, CookieSource.ofFile("C:/spicetify/youtube.cookies").ytDlpArguments())
        setCookieArguments(ProviderType.YOUTUBE_VIDEO, CookieSource.ofFile("C:/spicetify/youtube.cookies").ytDlpArguments())
        setCookieArguments(ProviderType.SOUNDCLOUD, CookieSource.ofFile("C:/spicetify/soundcloud.cookies").ytDlpArguments())
    }
    ...
    fun `soundcloud streams keep the session`() {
        ...
        assertEquals(
            listOf("--cookies", "C:/spicetify/soundcloud.cookies"),
    ...
    fun `browsing youtube still uses the session`() {
        ...
        assertEquals(
            listOf("--cookies", "C:/spicetify/youtube.cookies"),
