...
import app.spicetify.domain.Playlist
 ...
 *
 * Spicetify reaches it with the session from a signed-in browser rather than an OAuth client, because Google
...
class YouTubeMusicClient internal constructor(
     ...
     * and artists and albums mixed in among the songs. Every one of those gaps was visible in Spicetify — a
