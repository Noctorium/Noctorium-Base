...
val SpicetifyPanel = Color(0xFF07050A)
val SpicetifyPurple = Color(0xFFB47CFF)
val SpicetifyPurpleStrong = Color(0xFF8B5CF6)
val SpicetifyPurpleDark = Color(0xFF2A1248)
val SpicetifyLavender = Color(0xFFD8B4FE)

val SpicetifyColors = darkColorScheme(
    primary = SpicetifyPurple,
    onPrimary = Color(0xFF16002D),
    primaryContainer = SpicetifyPurpleDark,
    onPrimaryContainer = SpicetifyLavender,
    secondary = SpicetifyLavender,
 ...
 */
fun spicetifyColorScheme(accent: Color, background: Color) = darkColorScheme(
    primary = accent,
...
val SpicetifyDarkBackground = Color(0xFF0D0B12)
