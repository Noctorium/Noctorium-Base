...
internal class DefaultScrobbleHttpClient : ScrobbleHttpClient {
    ...
    private suspend fun request(
        ...
        connection.setRequestProperty("User-Agent", "Spicetify/0.1 desktop scrobbler")
    ...
    private suspend fun submit(token: String, type: String, track: ScrobbleTrack, listenedAt: Long?) {
        val metadata = buildJsonObject {
            ...
            putJsonObject("additional_info") {
                put("media_player", "Spicetify")
                put("submission_client", "Spicetify")
...
/**
 * Application identifiers for this Spicetify build. They identify the installation to Last.fm, never a listener —
 * account approval always happens in the browser. Set SPICETIFY_LASTFM_API_KEY and SPICETIFY_LASTFM_SHARED_SECRET to
...
internal object LastFmApplication {
    ...
    val apiKey: String get() = env("SPICETIFY_LASTFM_API_KEY") ?: BUILT_IN_API_KEY
    val sharedSecret: String get() = env("SPICETIFY_LASTFM_SHARED_SECRET") ?: BUILT_IN_SHARED_SECRET
