...
Use yt-dlp `2026.06.09` or newer. That release fixed a cookie leak affecting external curl-based downloads. Spiceity will check the detected version in Diagnostics and will never silently fetch executables from untrusted locations.
