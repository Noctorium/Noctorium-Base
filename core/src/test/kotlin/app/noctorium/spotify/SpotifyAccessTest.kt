...
class SpotifyAccessTest {
    ...
    /**
     * A 500 from Spotify, a rate limit, or a request this got wrong are all Spotify's problem or Noctorium's
...
class SpotifyMatchStoreTest {
    private val folder = Files.createTempDirectory("noctorium-spotify-matches")
