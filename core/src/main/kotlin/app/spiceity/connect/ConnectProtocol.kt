...
/**
 * What one Spiceity says to another on a local network.
 *
 * Spiceity Connect is deliberately small. Two of a listener's own devices announce themselves over UDP,
