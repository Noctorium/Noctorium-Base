...
/**
 * The handful of things Noctorium asks the machine it is running on to do.
 *
...
interface SystemBridge {
     ...
     *
     * Implementations reject anything that is not https. Every address Noctorium opens is one it built from
